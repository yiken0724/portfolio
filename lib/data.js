...
export const projects = [
  ...
  {
    id: 5,
    title: 'AI Insights — F&N Data Migration & ML Pipeline',
    description:
      'During internship at Frasers & Neaves Ltd: engineered a data migration pipeline using SharePoint Graph API, REST API, and Azure Active Directory to automate transfer of 1,500+ files into Microsoft Fabric. Also trained a CNN model for product recognition and integrated OpenAI GPT-4 API for automated data extraction.',
    category: 'Data',
    tags: ['Python', 'OpenAI GPT-4', 'CNN', 'Azure', 'SharePoint API', 'Selenium', 'Power BI', 'ANOVA'],
    github: null,
    demo: null,
    featured: false,
    year: 2025,
    metrics: ['1,500+ files migrated', 'Migration time: 2h → 3min', 'CNN accuracy +40%', 'Workflow efficiency +15%'],
  },
  {
    id: 6,
