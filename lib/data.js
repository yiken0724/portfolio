...
export const experience = [
  {
    ...
    type: 'Internship',
    description:
      'AI and data intern driving analytics, automation, computer vision, and ML initiatives across F&N, delivering data-driven insights to business stakeholders.',
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      'MATH: Calculus, Linear Algebra, Foundation of Mathematics, Discrete Mathematics, Probability, Statistics, Data Analysis, Regression Analysis, Statistical Learning, Sampling, Differential Equations, Cryptography',
      'COMPUTER SCIENCE: Digital Logic, Computer Architecture, Operating Systems, Software Engineering, Databases, Data Mining, Computer Vision, Data Science & AI',
    ],
